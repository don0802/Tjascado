...
<body id="home-body">
    ...
    <header id="home-header">
        ...
        <nav>
            ...
            <article id="home-header-art-2">
                <a><img src="../media/afbeeldingen//Home/search-transparent-white1.png" id="home-img1"></a>
                <a href="../pages/login.html"><img src="../media/afbeeldingen/Home/profile-transparent-white2.png" id="home-img2"></a>
            </article>
    </header>
    <!----------------------------------------------------MAIN / VIDEO------------------------------------------------------------------------->
    <main id="#home-main">
